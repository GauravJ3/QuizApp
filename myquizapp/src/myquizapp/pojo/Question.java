...
public class Question {
    ...
    public String toString() {
        return "Questions{" + "answer1=" + answer1 + ", answer2=" + answer2 + ", answer3=" + answer3 + ", answer4=" + answer4 + ", correctAnswer=" + correctAnswer + ", examId=" + examId + ", qno=" + qno + ", language=" + language + ", question=" + question + '}';
    }
